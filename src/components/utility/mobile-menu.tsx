...
export default function MobileMenu({
  ...
  return (
    <Transition show={openMenu}>
      <Dialog className="z-50" onClose={setOpenMenu}>
        <div className="fixed inset-0 flex items-center justify-center">
          ...
          >
            <DialogPanel className="pointer-events-none absolute flex min-h-[85%] w-full flex-col items-center justify-center overflow-y-auto rounded-b-2xl border-2 border-accent/20 bg-background px-6 py-8 text-accent shadow-lg shadow-accent/10 md:px-10 md:py-16">
              ...
              <div className="absolute bottom-0 py-6">©2023 Saad Aziz</div>
            </DialogPanel>
          </TransitionChild>
        </div>
      </Dialog>
