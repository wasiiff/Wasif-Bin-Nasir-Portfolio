...
export default function LandingHero() {
  ...
  return (
    ...
    >
      {/* faded "WBN" monogram watermark — editorial style */}
      <span
        aria-hidden
        ...
        <div className="mx-auto max-w-7xl">
          <AnimatePresence>
            ...
            <FadeUp key="title-main" duration={0.6} delay={0.18}>
              <h1 className="mt-4 text-[15vw] font-bold leading-[0.95] tracking-tighter text-foreground sm:text-7xl md:text-8xl xl:text-[9rem]">
                Wasif
                <br />
            ...
            <FadeUp key="description" duration={0.6} delay={0.28}>
              <div className="mt-8 grid max-w-5xl gap-4 md:grid-cols-12 md:gap-8">
                <p className="text-base font-medium leading-relaxed text-foreground/80 md:col-span-9 md:text-xl">
                  I build enterprise-grade web apps, AI-powered pipelines, and
                  blockchain-integrated platforms with{" "}
                  ...
                  Production systems that automate workflows and scale.
                </p>
              </div>
            </FadeUp>
